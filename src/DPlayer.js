...
import utils, { isMobile, isQQBrowser } from './utils';
...
class DPlayer {
    ...
    constructor (options) {
        ...
        options.isQQBrowser = isQQBrowser;
        ...
        {
            pbar.addEventListener('touchstart', this.mouseHandler);
            pbar.addEventListener('touchmove', this.mouseHandler);
            pbar.addEventListener('touchend', this.mouseHandler);
        }
        else
        {
